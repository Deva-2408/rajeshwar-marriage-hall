...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Rajeshwar Marriage Hall" },
      { property: "og:title", content: "Rajeshwar Marriage Hall - Bihta, Bihar" },
      { property: "og:description", content: "Rajeshwar Marriage Hall - Premier wedding venue in Bihta, Bihar, India" },
